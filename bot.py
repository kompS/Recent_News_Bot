...
if __name__ == '__main__':
	...
	loop.create_task(scheduled_eng(5))
	loop.create_task(scheduled_anime(5))
	loop.create_task(scheduled_tech(5))
	loop.create_task(scheduled_sale(5))
	loop.create_task(scheduled_sport(5))
	loop.create_task(scheduled_kino(5))
	loop.create_task(scheduled_mus(5)) 
